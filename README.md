...
Some exercises and concepts explorations on compiler design using several tools available for the Java enviroment. Here I explore topics such as parsing, lexical analysis, semantic analysis,  type checking, code optimization, garbage collection, etc. The main resources for that are:
